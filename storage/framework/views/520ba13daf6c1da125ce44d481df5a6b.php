...
<?php $__env->startSection('page-title', 'Nueva Solicitud'); ?>
                ...
                <form method="POST" action="<?php echo e(route('requests.store')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="type" id="requestType" required>
                            <option value="vacation" <?php echo e(old('type') == 'vacation' ? 'selected' : ''); ?>>Vacaciones</option>
                            <option value="permission" <?php echo e(old('type') == 'permission' ? 'selected' : ''); ?>>Permiso</option>
                            <option value="work_letter" <?php echo e(old('type') == 'work_letter' ? 'selected' : ''); ?>>Carta de Trabajo</option>
                            <option value="overtime" <?php echo e(old('type') == 'overtime' ? 'selected' : ''); ?>>Horas Extra</option>
                        </select>
                    </div>
                        ...
                        <div class="p-3 rounded-3 mb-3" style="background: rgba(251,146,60,0.07); border: 1px solid rgba(251,146,60,0.2);">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-12">
                                    ...
                                    <input type="date" class="form-control" name="overtime_date" id="overtimeDate" value="<?php echo e(old('overtime_date')); ?>">
                                </div>
                            </div>
                            <div class="row g-3 mb-3">
                                <div class="col-md-5">
                                    <label class="form-label">Hora de Inicio</label>
                                    <input type="time" class="form-control" name="overtime_start" id="overtimeStart" value="<?php echo e(old('overtime_start')); ?>">
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label">Hora de Fin</label>
                                    <input type="time" class="form-control" name="overtime_end" id="overtimeEnd" value="<?php echo e(old('overtime_end')); ?>">
                                </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" rows="4" placeholder="Explique el motivo de su solicitud..."><?php echo e(old('description')); ?></textarea>
                    </div>

                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary-custom"><i class="bi bi-send me-1"></i> Enviar Solicitud</button>
                        <a href="<?php echo e(route('requests.index')); ?>" class="btn btn-outline-custom">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Freddy\Desktop\proyectos\anti\resources\views/requests/create.blade.php ENDPATH**/ ?>
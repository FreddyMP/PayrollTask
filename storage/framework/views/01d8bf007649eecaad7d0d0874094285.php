...
<body>
    <div class="select-card">
        <div class="brand-header">
            ...
            <p>Hola, <strong style="color: #e2e8f0;"><?php echo e(Auth::user()->name); ?></strong>. Selecciona la empresa para continuar.</p>
        </div>

        <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form method="POST" action="<?php echo e(route('select-company.post')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="company_id" value="<?php echo e($employee->company_id); ?>">
                <button type="submit" class="company-btn">
                    <div class="company-icon">
                        <?php echo e(strtoupper(substr($employee->company->name, 0, 2))); ?>

                    </div>
                    <div>
                        <div class="company-name"><?php echo e($employee->company->name); ?></div>
                        <div class="company-role">
                            <i class="bi bi-person-badge me-1"></i>
                            <?php echo e(ucfirst($employee->role ?? $employee->user->role ?? 'usuario')); ?>
...
<?php /**PATH C:\Users\Freddy\Desktop\proyectos\anti\resources\views/auth/select-company.blade.php ENDPATH**/ ?>
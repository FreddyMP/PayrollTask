<?php $__env->startSection('title', 'Tablero de Tareas'); ?>
<?php $__env->startSection('page-title', 'Tablero de Tareas'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mb-4" id="filtersCard">
        <div class="card-body">
            ...
            <div class="collapse show" id="filtersCollapse">
                <form id="filtersForm" method="GET" action="<?php echo e(route('tasks.index')); ?>">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="filterStatus" name="status" class="form-select form-select-sm">
                                ...
                                <option value="in_progress" <?php echo e(request('status') == 'in_progress' ? 'selected' : ''); ?>>En
                                    Progreso</option>
                                <option value="review" <?php echo e(request('status') == 'review' ? 'selected' : ''); ?>>Revisión</option>
                                <option value="completed" <?php echo e(request('status') == 'completed' ? 'selected' : ''); ?>>Completada
                                </option>
                                <option value="cancelled" <?php echo e(request('status') == 'cancelled' ? 'selected' : ''); ?>>Cancelada
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="filterPriority" name="priority" class="form-select form-select-sm">
                                ...
                                <option value="low" <?php echo e(request('priority') == 'low' ? 'selected' : ''); ?>>Baja</option>
                                <option value="medium" <?php echo e(request('priority') == 'medium' ? 'selected' : ''); ?>>Media</option>
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="<?php echo e(route('tasks.index')); ?>" class="btn btn-outline-custom btn-sm">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <?php if(auth()->user()->isSupervisor()): ?>
            <a href="<?php echo e(route('tasks.create')); ?>" class="btn btn-primary-custom">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr id="task-<?php echo e($task->id); ?>">
                                    <td>
                                        ...
                                        <?php if($task->description): ?>
                                            <div style="font-size: 0.75rem; color: #64748b;">
                                                <?php echo e(Str::limit($task->description, 60)); ?></div>
                                        <?php endif; ?>
                                        <?php if($task->project): ?>
                                            <div class="mt-1">
                                                <span class="badge bg-dark-3 text-secondary small" style="font-size: 0.65rem;">
                                                    <i class="bi bi-folder2-open me-1"></i> <?php echo e($task->project->name); ?>
                                    ...
                                    <td>
                                        <select class="form-select form-select-sm status-select" data-task-id="<?php echo e($task->id); ?>"
                                            style="width: auto; font-size: 0.75rem;">
                                            <option value="pending" <?php echo e($task->status == 'pending' ? 'selected' : ''); ?>>Pendiente
                                            </option>
                                            <option value="in_progress" <?php echo e($task->status == 'in_progress' ? 'selected' : ''); ?>>En
                                                Progreso</option>
                                            <option value="review" <?php echo e($task->status == 'review' ? 'selected' : ''); ?>>Revisión
                                            </option>
                                    ...
                                    <td><span
                                            class="badge-status badge-<?php echo e($task->priority); ?>"><?php echo e(ucfirst($task->priority)); ?></span>
                                    </td>
                                    ...
                                    <td>
                                        <?php if($task->due_date): ?>
                                            <span
                                                class="<?php echo e($task->due_date->isPast() && $task->status !== 'completed' ? 'text-danger' : ''); ?>">
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <button type="button" class="btn btn-outline-custom btn-sm view-task"
                                                data-title="<?php echo e($task->title); ?>" data-description="<?php echo e($task->description); ?>"
                                                data-status="<?php echo e($task->status); ?>" data-priority="<?php echo e($task->priority); ?>"
                                                data-assigned="<?php echo e($task->assignedUser->name ?? '—'); ?>"
                                                data-creator="<?php echo e($task->creator->name ?? '—'); ?>"
                                                data-due="<?php echo e($task->due_date ? $task->due_date->format('d/m/Y') : '—'); ?>"
                                                data-attachments="<?php echo e($task->attachments->map(fn($a) => ['path' => Storage::url($a->file_path), 'type' => $a->file_type, 'group' => $a->uploader_group, 'user' => $a->user->name])->toJson()); ?>"
                                                title="Ver Detalles">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                            <?php if(auth()->user()->isSupervisor()): ?>
                                                <a href="<?php echo e(route('tasks.edit', $task)); ?>" class="btn btn-outline-custom btn-sm"
                                                    title="Editar">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <form method="POST" action="<?php echo e(route('tasks.destroy', $task)); ?>" class="d-inline"
        ...
        <div class="row g-4">
            <?php $__empty_1 = true; $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-6 col-xl-4">
                    <div class="task-card-modern" id="card-task-<?php echo e($task->id); ?>">
                        <div class="task-card-header">
                            <span class="badge-status badge-<?php echo e($task->priority); ?> "><?php echo e(ucfirst($task->priority)); ?></span>
                            <div class="dropdown">
                                <button class="btn btn-link text-white p-0" type="button" data-bs-toggle="dropdown">
                                    <i class="bi bi-three-dots-vertical"></i>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end">
                                    <li><button class="dropdown-item view-task" data-title="<?php echo e($task->title); ?>"
                                            data-description="<?php echo e($task->description); ?>" data-status="<?php echo e($task->status); ?>"
                                    ...
                                    <?php if(auth()->user()->isSupervisor()): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('tasks.edit', $task)); ?>"><i
                        ...
                        <div class="task-card-body">
                            <h5 class="task-title"><?php echo e($task->title); ?></h5>
                            <p class="task-desc"><?php echo e(Str::limit($task->description, 100)); ?></p>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-auto">
                                <div class="task-user">
                                    <div class="user-avatar-sm"><?php echo e(strtoupper(substr($task->assignedUser->name ?? '?', 0, 1))); ?>

                                    </div>
                                    <span><?php echo e($task->assignedUser->name ?? 'Sin asignar'); ?></span>
                                </div>
                                <div
                                    class="task-date <?php echo e($task->due_date && $task->due_date->isPast() && $task->status !== 'completed' ? 'text-danger' : ''); ?>">
                                    <i class="bi bi-calendar3 me-1"></i>
                                    <?php echo e($task->due_date ? $task->due_date->format('d M') : '—'); ?>
                        ...
                        <div class="task-card-footer border-top border-light border-opacity-10 mt-3 pt-3">
                            <select class="form-select form-select-sm status-select" data-task-id="<?php echo e($task->id); ?>">
                                <option value="pending" <?php echo e($task->status == 'pending' ? 'selected' : ''); ?>>Pendiente</option>
                                <option value="in_progress" <?php echo e($task->status == 'in_progress' ? 'selected' : ''); ?>>En Progreso
                                </option>
                                <option value="review" <?php echo e($task->status == 'review' ? 'selected' : ''); ?>>Revisión</option>
                                <option value="completed" <?php echo e($task->status == 'completed' ? 'selected' : ''); ?>>Completada</option>
                                <option value="cancelled" <?php echo e($task->status == 'cancelled' ? 'selected' : ''); ?>>Cancelada</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Freddy\Desktop\proyectos\anti\resources\views/tasks/index.blade.php ENDPATH**/ ?>
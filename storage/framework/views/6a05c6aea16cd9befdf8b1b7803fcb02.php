                    ...
                    <form method="POST" action="<?php echo e(route('payroll.store')); ?>">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control" name="gross_salary" id="grossSalary"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="card shadow-sm border-success" style="border-left: 4px solid #198754;">
                                    <div class="card-body">
                                        <h6 class="card-title text-success mb-3"><i class="bi bi-arrow-up-circle me-1"></i>
                                            Incentivos / Extras</h6>
                                        <div id="incentivesContainer"></div>
                                        <button type="button" class="btn btn-sm btn-outline-success mt-2"
                                            onclick="addIncentiveRow()">+ Agregar Incentivo</button>
                                        <div class="mt-3 text-white fw-bold">Total Incentivos: RD$ <span
                                                id="totalIncentivesDisplay">0.00</span></div>
                            ...
                            <div class="col-md-6">
                                <div class="card shadow-sm border-danger" style="border-left: 4px solid #dc3545;">
                                    <div class="card-body">
                                        <h6 class="card-title text-danger mb-3"><i class="bi bi-arrow-down-circle me-1"></i>
                                            Otros Descuentos</h6>
                                        <div id="discountsContainer"></div>
                                        <button type="button" class="btn btn-sm btn-outline-danger mt-2"
                                            onclick="addDiscountRow()">+ Agregar Descuento</button>
                                        <div class="mt-3 text-white fw-bold">Total Descuentos: RD$ <span
                                                id="totalDiscountsDisplay">0.00</span></div>
                                        <input type="hidden" name="descuentos" id="descuentos" value="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-3 mb-4 p-3" id="overtimeBlock"
                            ...
                            <div class="d-flex align-items-center gap-2 mb-3">
                                ...
                                <span class="fw-semibold"
                                    style="color: #fb923c; font-size: 0.82rem; text-transform: uppercase; letter-spacing: 0.04em;">
                            ...
                            <div class="row g-3 align-items-end">
                                <div class="col-md-4">
                                    <label class="form-label">
                                        ...
                                        <i class="bi bi-info-circle ms-1"
                                            title="Suma de horas extra aprobadas para este empleado en el período seleccionado"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text"
                                            style="background: rgba(251,146,60,0.12); border-color: rgba(251,146,60,0.3); color: #fb923c;">h</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"
                                            style="background: rgba(251,146,60,0.12); border-color: rgba(251,146,60,0.3); color: #fb923c;">RD$</span>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="p-2 rounded-2 text-center"
                                        style="background: rgba(251,146,60,0.1); border: 1px solid rgba(251,146,60,0.2); font-size: 0.75rem; color: #94a3b8; line-height: 1.5;">
                            ...
                            <div id="overtimeDetails" class="mt-3 pt-3 border-top border-warning-20 d-flex flex-wrap gap-2"
                                style="display:none !important;">
                                <div class="px-2 py-1 rounded-2"
                                    style="background:rgba(255,255,255,0.05); border:1px solid rgba(251,146,60,0.1); font-size:0.75rem;">
                                    <span class="text-white">Diurnas:</span> <span id="detailDiurnas"
                                        class="fw-semibold text-white">0</span>h
                                </div>
                                <div class="px-2 py-1 rounded-2"
                                    style="background:rgba(255,255,255,0.05); border:1px solid rgba(251,146,60,0.1); font-size:0.75rem;">
                                    <span class="text-white">Nocturnas:</span> <span id="detailNocturnas"
                                        class="fw-semibold text-white">0</span>h
                                </div>
                                <div class="px-2 py-1 rounded-2"
                                    style="background:rgba(251,146,60,0.1); border:1px solid rgba(251,146,60,0.2); font-size:0.75rem;">
                                    <span class="text-white">Feriados/Descanso:</span> <span id="detailFeriados"
                                        class="fw-semibold text-white">0</span>h
                                </div>
                            </div>
                            ...
                            <div id="overtimeEmptyMsg" class=" text-white small mt-2" style="display:none;">
                                <i class="bi bi-info-circle me-1 text-white"></i> No hay horas extra aprobadas para este
                                empleado en el período seleccionado.
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control bg-light text-secondary" name="ars"
                                    id="ars" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">AFP (2.87%)</label>
                                <input type="number" step="0.01" class="form-control bg-light text-secondary" name="afp"
                                    id="afp" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">ISR</label>
                                <input type="number" step="0.01" class="form-control bg-light text-secondary" name="isr"
                                    id="isr" readonly>
                            </div>
                        </div>

<?php $__env->startSection('title', 'Reclutamiento'); ?>
<?php $__env->startSection('page-title', 'Reclutamiento'); ?>
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('recruitment.application-form.print', $applicationForm)); ?>"
            ...
            <div class="tab-pane fade show active" id="vacancies-pane">
                ...
                <div class="card mb-3">
                    <div class="card-header bg-dark-2 py-3">
                        <button
                            ...
                            <span>
                                ...
                                <?php if(request()->hasAny(['search', 'status', 'department', 'date_from', 'date_until'])): ?>
                    ...
                    <div class="collapse" id="filtersCollapse">
                        <div class="card-body">
                            <form method="GET" action="<?php echo e(route('recruitment.index')); ?>" id="filterForm">
                                <input type="hidden" name="tab" value="vacancies">
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        <label class="form-label">Buscar por título</label>
                                        <input type="text" name="search" class="form-control"
                                            placeholder="Buscar vacante..." value="<?php echo e(request('search')); ?>">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">Estado</label>
                                        <select name="status" class="form-select">
                                            <option value="">Todos</option>
                                            <option value="open" <?php echo e(request('status') === 'open' ? 'selected' : ''); ?>>Abierta
                                            </option>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="date" name="date_until" class="form-control"
                                            value="<?php echo e(request('date_until')); ?>">
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-12 d-flex gap-2">
                                        ...
                                        <a href="<?php echo e(route('recruitment.index')); ?>" class="btn btn-outline-custom">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fw-bold text-dark"><?php echo e($vacancy->title); ?></div>
                                                        <small
                                                            class="text-dark"><?php echo e(Str::limit($vacancy->description, 40)); ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td><?php echo e($vacancy->department ?? 'N/A'); ?></td>
                                            <td>
                                                <span
                                                    class="badge badge-status badge-in_progress"><?php echo e($vacancy->candidates_count); ?>

                                                    postulados</span>
                                            </td>
                                            <td>
                                                <span
                                                    class="badge badge-status badge-<?php echo e($vacancy->status === 'open' ? 'active' : 'rejected'); ?>">
                                                    <?php echo e($vacancy->status === 'open' ? 'Abierta' : 'Cerrada'); ?>

                                                </span>
                                            </td>
                                            <td><?php echo e($vacancy->created_at->format('d/m/Y')); ?></td>
                                            <td class="text-end">
                                                <?php if($vacancy->status === 'open'): ?>
                                                    <a href="<?php echo e(route('recruitment.show', $vacancy)); ?>"
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card shadow-sm border-0 mb-4">
                            ...
                            <div class="card-body">
                                <form action="<?php echo e(route('recruitment.application-form.fields.store', $applicationForm)); ?>"
                                    method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-3">
                    ...
                    <div class="col-lg-8">
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-dark-2 py-3 d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge bg-primary"><?php echo e($applicationForm->fields->count()); ?> campos</span>
                            </div>
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle mb-0">
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $applicationForm->fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td class="ps-3 text-dark"><?php echo e($loop->iteration); ?></td>
                                                    <td>
                                                        <div class="text-dark fw-medium"><?php echo e($field->label); ?></div>
                                                        <?php if($field->type === 'table'): ?>
                                                            <div class="mt-1">
                                                                <?php $__currentLoopData = $field->options['columns'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <span class="badge bg-dark-3 text-white border border-secondary"
                                                                        style="font-size: 0.65rem;"><?php echo e($col); ?></span>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </div>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="badge badge-status badge-supervisor"><?php echo e(ucfirst(str_replace('_', ' ', $field->type))); ?></span>
                                                    </td>
                                                    <td class="text-end pe-3">
                                                        <form
                                                            action="<?php echo e(route('recruitment.application-form.fields.destroy', $field)); ?>"
        ...
        <div class="modal fade" id="createVacancyModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="<?php echo e(route('recruitment.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Freddy\Desktop\proyectos\anti\resources\views/recruitment/index.blade.php ENDPATH**/ ?>
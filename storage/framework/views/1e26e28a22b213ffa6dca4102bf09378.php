...
<body>
    ...
    <div class="card-wrap">
        ...
        <form method="POST" action="<?php echo e(route('referentes.register.post')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text"
                           ...
                           id="nombre_completo"
                           class="form-control border-start-0 <?php $__errorArgs = ['nombre_completo'];
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text"
                           name="cedula_rnc"
                           id="cedula_rnc"
                           class="form-control border-start-0 <?php $__errorArgs = ['cedula_rnc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                           ...
                           value="<?php echo e(old('cedula_rnc')); ?>"
                           required>
                </div>
                <?php $__errorArgs = ['cedula_rnc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="tel"
                           name="telefono"
                           id="telefono"
                           class="form-control border-start-0 <?php $__errorArgs = ['telefono'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center">
            <a href="<?php echo e(route('referentes.login')); ?>" class="link-accent">
...
<?php /**PATH C:\Users\Freddy\Desktop\proyectos\anti\resources\views/referentes/register.blade.php ENDPATH**/ ?>
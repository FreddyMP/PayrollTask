...
<?php $__env->startSection('page-title', 'Mi Panel'); ?>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="stat-card purple">
                ...
                <div class="stat-value"><?php echo e($pendingEvaluations->count()); ?></div>
        ...
        <div class="col-md-4">
            <div class="stat-card orange">
                ...
                <div class="stat-value"><?php echo e(collect($myRequests)->where('status', 'pending')->count()); ?></div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-3" style="border-left: 3px solid var(--primary);">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <?php if($pendingEvaluations->count() > 0): ?>
                        <span class="badge bg-danger rounded-pill"><?php echo e($pendingEvaluations->count()); ?> Pendientes</span>
                    <?php endif; ?>
                </div>
                <div class="card-body p-0">
                    <?php $__empty_1 = true; $__currentLoopData = $pendingEvaluations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="d-flex align-items-center justify-content-between p-3" style="border-bottom: 1px solid rgba(255,255,255,0.04);">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <div style="font-size: 0.95rem; font-weight: 600; color: white;"><?php echo e($assignment->evaluation->title); ?></div>
                                    <div style="font-size: 0.75rem; color: #94a3b8; margin-top: 2px;"><?php echo e(Str::limit($assignment->evaluation->description, 60)); ?></div>
                                </div>
                            </div>
                            <a href="<?php echo e(route('evaluations.fill', $assignment->evaluation)); ?>" class="btn btn-primary-custom btn-sm">Completar <i class="bi bi-arrow-right ms-1"></i></a>
                        </div>
            ...
            <div class="card mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('requests.index')); ?>" class="btn btn-outline-custom btn-sm">Ver todas</a>
                </div>
                <div class="card-body p-0">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $myRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <span style="font-weight: 500; color: white;"><?php echo e($typeLabels[$req->type] ?? ucfirst($req->type)); ?></span>
                                        </td>
                                        <td><?php echo e($req->created_at->format('d/m/Y')); ?></td>
                                        <td>
                                            <span class="badge-status badge-<?php echo e($req->status); ?>"><?php echo e(ucfirst($req->status)); ?></span>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                ...
                <div class="card" style="background: linear-gradient(135deg, rgba(6, 182, 212, 0.1), rgba(59, 130, 246, 0.1)); border: 1px solid rgba(59, 130, 246, 0.2);">
                    <div class="card-body d-flex align-items-center justify-content-between p-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="text-white mb-1" style="font-weight: 600;">Tienes <?php echo e($pendingTasksCount); ?> tareas pendientes</h5>
                                <p class="mb-0" style="color: #94a3b8; font-size: 0.85rem;">Revisa tu tablero para organizarte y avanzar.</p>
                            </div>
                        </div>
                        <a href="<?php echo e(route('tasks.index')); ?>" class="btn btn-outline-custom" style="border-color: #3b82f6; color: #60a5fa;">Ir a Tareas</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body p-0">
                    <?php $__empty_1 = true; $__currentLoopData = $activeRegulations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <a href="<?php echo e(route('regulations.show', $reg)); ?>" class="d-flex align-items-center gap-3 px-3 py-3 text-decoration-none" style="border-bottom: 1px solid rgba(255,255,255,0.04); transition: background 0.2s;">
                            ...
                            <div style="flex: 1; min-width: 0;">
                                <div style="font-size: 0.85rem; font-weight: 600; color: white; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo e($reg->title); ?></div>
                                <div style="font-size: 0.7rem; color: #64748b;">Actualizado <?php echo e($reg->updated_at->diffForHumans()); ?></div>
                            </div>
                    ...
                    <div class="p-2 text-center" style="border-top: 1px solid rgba(255,255,255,0.04);">
                        <a href="<?php echo e(route('regulations.index')); ?>" style="font-size: 0.8rem; color: var(--primary-light); text-decoration: none; font-weight: 500;">Explorar todos los documentos <i class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $todayEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="px-3 py-2" style="border-bottom: 1px solid rgba(255,255,255,0.04); border-left: 3px solid var(--accent);">
                            <div style="font-size: 0.7rem; color: var(--accent); font-weight: 600; margin-bottom: 2px;">
                                <i class="bi bi-clock me-1"></i><?php echo e(\Carbon\Carbon::parse($event->event_time)->format('h:i A')); ?>

                            </div>
                            <div style="font-size: 0.85rem; font-weight: 600; color: white;"><?php echo e($event->title); ?></div>
                            <?php if($event->links && $event->links->isNotEmpty()): ?>
                                <div class="mt-1 d-flex gap-1 flex-wrap">
                                    <?php $__currentLoopData = $event->links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e($link->url); ?>" target="_blank" style="font-size: 0.65rem; padding: 2px 6px; background: rgba(255,255,255,0.05); color: #94a3b8; border-radius: 4px; text-decoration: none;">
        ...
        <div class="today-modal-overlay" id="todayModal">
            <div class="today-modal">
                <div class="today-modal-header">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <small style="color:var(--dark-4);font-size:0.7rem;"><?php echo e(now()->translatedFormat('l, d \d\e F Y')); ?></small>
                        </div>
                    </div>
                ...
                <div class="today-modal-body">
                    <?php $__currentLoopData = $todayEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="today-event-card">
                            <div class="today-event-time"><i class="bi bi-clock me-1"></i><?php echo e(\Carbon\Carbon::parse($event->event_time)->format('h:i A')); ?></div>
                            <div class="today-event-title"><?php echo e($event->title); ?></div>
                            <?php if($event->description): ?><div class="today-event-desc"><?php echo e($event->description); ?></div><?php endif; ?>
                            <?php if($event->links->isNotEmpty()): ?>
                                <div class="today-event-links">
                                    <?php $__currentLoopData = $event->links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e($link->url); ?>" target="_blank"><i class="bi bi-link-45deg"></i><?php echo e($link->label ?: $link->url); ?></a>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <div class="today-modal-footer">
                    <a href="<?php echo e(route('calendar.index')); ?>" class="btn btn-primary-custom w-100"><i class="bi bi-calendar-event me-2"></i>Ir al Calendario</a>
                </div>
            </div>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Freddy\Desktop\proyectos\anti\resources\views/dashboard/usuario.blade.php ENDPATH**/ ?>
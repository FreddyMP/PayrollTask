                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex gap-4 align-items-start">
                            <div class="flex-shrink-0">
                                <?php if ($company->logo): ?>
                                    <img src="<?php echo e(\Storage::disk('s3')->url($company->logo)); ?>" alt="Logo"
                                        class="rounded-3"
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="rnc"
                                value="<?php echo e(old('rnc', $company->rnc)); ?>">
                        </div>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control text-dark"
                                value="<?php echo e(ucfirst($company->plan)); ?>" disabled>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Estado</label>
                            <input type="text" class="form-control text-dark"
                                value="<?php echo e(ucfirst($company->status)); ?>" disabled>
                        </div>
                    </div>
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="payroll_frequency" id="payroll_frequency">
                                <option value="" <?php if (is_null($company->payroll_frequency)):
                                    echo 'selected'; endif; ?>>— Seleccionar —</option>
                                <option value="monthly" <?php if ($company->payroll_frequency === 'monthly'):
                                    echo 'selected'; endif; ?>>Mensual (12 períodos / año)</option>
                                <option value="biweekly" <?php if ($company->payroll_frequency === 'biweekly'):
                                    echo 'selected'; endif; ?>>Quincenal (24 períodos / año)</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="bonus_payment_method" id="bonus_payment_method">
                                <option value="payroll" <?php if (old('bonus_payment_method', $company->bonus_payment_method) === 'payroll'):
                                    echo 'selected'; endif; ?>>Pagar con
                                    la Nómina</option>
                                <option value="separate" <?php if (old('bonus_payment_method', $company->bonus_payment_method) === 'separate'):
                                    echo 'selected'; endif; ?>>Pago
                                    Separado</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4" id="bonus_split_container" style="display: none;">
                        <div class="col-md-12">
                            ...
                            <select class="form-select" name="bonus_biweekly_split">
                                ...
                                <option value="both" <?php if (old('bonus_biweekly_split', $company->bonus_biweekly_split) === 'both'):
                                    echo 'selected'; endif; ?>>Ambas
                                    Quincenas (Dividido)</option>
                                <option value="q1" <?php if (old('bonus_biweekly_split', $company->bonus_biweekly_split) === 'q1'):
                                    echo 'selected'; endif; ?>>1ra Quincena
                                    (Completo)</option>
                                <option value="q2" <?php if (old('bonus_biweekly_split', $company->bonus_biweekly_split) === 'q2'):
                                    echo 'selected'; endif; ?>>2da Quincena
                                    (Completo)</option>
                            </select>

...
<head>
    ...
    <title>Recuperar Contraseña | PayrollTask</title>
    ...
    <div class="login-card">
        ...
        <form method="POST" action="<?php echo e(route('password.email')); ?>">
            ...
            <div class="text-center">
                <a href="<?php echo e(route('login')); ?>" style="color: #94a3b8; font-size: 0.875rem; text-decoration: none;">
...
<?php /**PATH C:\Users\Freddy\Desktop\proyectos\anti\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>
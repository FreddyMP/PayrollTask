...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => $__env->getContainer()->make(Illuminate\View\Factory::class)->make('mail::header'),'data' => ['url' => config('app.url'),'logoUrl' => $companyLogo ?? null,'companyLogo' => $companyLogo ?? null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(config('app.url')),'logoUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($companyLogo ?? null),'companyLogo' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($companyLogo ?? null)]); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
© <?php echo new \Illuminate\Support\EncodedHtmlString(date('Y')); ?> <?php echo new \Illuminate\Support\EncodedHtmlString($companyName ?? config('app.name')); ?>. <?php echo new \Illuminate\Support\EncodedHtmlString(__('All rights reserved.')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Freddy\Desktop\proyectos\anti\resources\views/vendor/mail/html/message.blade.php ENDPATH**/ ?>
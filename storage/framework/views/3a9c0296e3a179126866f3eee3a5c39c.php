<?php $__env->startSection('title', 'Prestaciones Laborales'); ?>
<?php $__env->startSection('page-title', 'Prestaciones Laborales (Cálculo)'); ?>
...
<?php $__env->startSection('content'); ?>
    <ul class="nav nav-tabs mb-4 px-3" style="border-bottom: 1px solid rgba(255,255,255,0.1);">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="<?php echo e(route('payroll.benefits')); ?>"
                ...
                <div class="card-body">
                        ...
                        <select id="employeeSelect" class="form-select">
                            ...
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($emp->id); ?>" data-salary="<?php echo e($emp->salary); ?>"
                                    data-hire="<?php echo e($emp->hire_date?->format('Y-m-d')); ?>">
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="date" id="exitDate" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                        </div>
                    </div>
                    ...
                    <h6 class="text-white mb-3"
                        style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--primary-light);">
                        Incluir en cálculo:</h6>
                    ...
                    <div class="form-check form-switch mb-4">
                        ...
                        <label class="form-check-label text-white" for="checkNavidad">Salario de Navidad
                            (Proporcional)</label>
                    </div>
                        ...
                        <table class="table table-dark mb-0">
                            ...
                            <tfoot>
                                <tr class="bg-primary bg-opacity-10 border-top border-primary">
                                    ...
                                    <td class="text-end pe-4 fw-bold text-primary py-3" id="totalValue"
                                        style="font-size: 1.2rem;">RD$ 0.00</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Freddy\Desktop\proyectos\anti\resources\views/payroll/benefits.blade.php ENDPATH**/ ?>
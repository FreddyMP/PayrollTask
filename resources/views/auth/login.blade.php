        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background: #1e293b; color: white; border: 1px solid rgba(255,255,255,0.1); border-radius: 16px;">
                ...
                <div class="modal-footer" style="border-top: 1px solid rgba(255,255,255,0.1);">
                    ...
                    <a href="{{ route('register') }}" class="btn btn-primary" style="background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 50%, #a855f7 100%); border: none; border-radius: 12px; font-weight: 600;">

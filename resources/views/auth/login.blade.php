    ...
    <div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content"
                style="background: #1e293b; color: white; border: 1px solid rgba(255,255,255,0.1); border-radius: 16px;">
                ...
                <div class="modal-body text-start" style="color: #cbd5e1;">
                    <p class="mb-3">Al registrarte hoy, obtendrás <strong>3 meses de prueba totalmente
                            gratuitos</strong> de nuestra plataforma de gestión.</p>
                    <p class="mb-0">Después del período de prueba, se requerirá una suscripción activa para continuar
                        utilizando nuestros servicios, la cual te permitirá seguir disfrutando de todas las
                        características empresariales.</p>
                </div>
                <div class="modal-footer" style="border-top: 1px solid rgba(255,255,255,0.1);">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        style="background: #334155; border: none; border-radius: 12px; color: white;">Cancelar</button>
                    <a href="{{ route('register') }}" class="btn btn-primary"
                        style="background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 50%, #a855f7 100%); border: none; border-radius: 12px; font-weight: 600;">

...
<head>
    ...
    <title>Nueva Contraseña | PayrollTask</title>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" class="form-control" name="email" value="{{ $email ?? old('email') }}"
                           placeholder="correo@empresa.com" required style="border-radius: 0 12px 12px 0">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" name="password"
                           placeholder="••••••••" required autofocus style="border-radius: 0 12px 12px 0">
                </div>
            </div>

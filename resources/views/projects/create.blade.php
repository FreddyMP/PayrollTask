    ...
    <div class="col-xl-8 col-lg-10">
        <div class="card bg-dark-2 border-0 shadow-lg">
            <div class="card-header border-bottom border-light bg-transparent p-4">
                ...
                <p class="text-muted small mb-0">Complete los detalles para iniciar un nuevo proyecto.</p>
            </div>
                ...
                <form action="{{ route('projects.store') }}" method="POST">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Ej: Rediseño de Sitio Web" required value="{{ old('name') }}">
                        </div>

                        <div class="col-12">
                            <label class="form-label text-uppercase small fw-bold" style="color: #94a3b8; letter-spacing: 0.05em;">Descripción</label>
                            <textarea name="description" class="form-control" rows="4" placeholder="Breve descripción del objetivo y alcance...">{{ old('description') }}</textarea>
                        </div>
                            ...
                            <div class="row g-2" style="max-height: 250px; overflow-y: auto;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check p-2 rounded-3" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05);">
                                        <input class="form-check-input ms-0 me-2" type="checkbox" name="team[]" value="{{ $user->id }}" id="user-{{ $user->id }}">

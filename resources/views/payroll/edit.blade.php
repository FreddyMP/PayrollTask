                ...
                <form method="POST" action="{{ route('payroll.update', $payroll) }}">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.01" class="form-control" name="extras" id="extras" value="{{ $payroll->extras }}">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Otros Descuentos</label>
                            <input type="number" step="0.01" class="form-control" name="descuentos" id="descuentos" value="{{ $payroll->descuentos }}">
                        </div>
                    </div>

...
<ul class="nav nav-tabs mb-4 px-3" style="border-bottom: 1px solid rgba(255,255,255,0.1);">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="{{ route('payroll.christmas') }}" style="color: white; border-bottom: 2px solid var(--primary); background: transparent; border-top: 0; border-left: 0; border-right: 0; padding: 0.75rem 1.25rem;">
            Salario Navidad
        </a>
    </li>
    <li class="nav-item">
            ...
            <table class="table mb-0">
                    ...
                    @forelse($employees as $employee)
                        @if($employee->hire_date)
                            ...
                            <tr>
                                ...
                                <td class="text-end fw-bold" style="color: var(--success);">RD$ {{ number_format($employee->christmas_salary, 2) }}</td>
                            </tr>
                        @endif
                    @empty
                        <tr>
                ...
                <tfoot>
                    <tr class="bg-primary bg-opacity-10 border-top border-primary">
                        ...
                        <td class="text-end fw-bold text-primary py-3" style="font-size: 1.1rem;">RD$ {{ number_format($totalChristmas, 2) }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>

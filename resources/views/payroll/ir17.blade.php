...
@section('content')
        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="small mb-0" style="color: #94a3b8;">Declaración Jurada Mensual del Impuesto Sobre la Renta —
    ...
    <div class="alert border-0 shadow-sm mb-4" style="background: rgba(251, 191, 36, 0.08); color: #fbbf24;">
        <div class="d-flex">
            ...
            <div>
                <h6 class="alert-heading fw-bold mb-1" style="color: #fbbf24;">Escala Progresiva ISR Vigente (Anualizada)
                </h6>
    ...
    <div class="mt-4 text-secondary small">
        <i class="bi bi-shield-check me-1"></i> Reporte generado conforme al formulario IR-17 de la Dirección General de
